...
public interface EstatisticasControllerOpenApi {
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "dataCriacaoInicio", value = "Data/hora da criação do pedido", example = "2019-10-30T00:00:00Z", dataType = "date-time"),
		@ApiImplicitParam(name = "dataCriacaoFim", value = "Data/hora final da criação do pedido", example = "2019-11-04T23:59:59Z", dataType = "date-time")
	})
