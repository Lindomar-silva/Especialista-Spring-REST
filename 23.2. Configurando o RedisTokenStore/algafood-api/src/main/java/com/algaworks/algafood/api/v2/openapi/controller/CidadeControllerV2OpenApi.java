...
public interface CidadeControllerV2OpenApi {
	...
	CidadeDTOV2 buscar(@ApiParam(value = "ID da cidade", example = "1", required = true) Long cidadeId);

	@ApiOperation("Cadastra uma cidade")
	@ApiResponse(responseCode = "201", description = "Cidade cadastrada")
	CidadeDTOV2 adicionar(@ApiParam(name = "corpo", value = "Representação de uma cidade", required = true) CidadeInputV2 cidadeInput);
	...
	CidadeDTOV2 atualizar(@ApiParam(value = "ID da cidade", example = "1", required = true) Long cidadeId, 
