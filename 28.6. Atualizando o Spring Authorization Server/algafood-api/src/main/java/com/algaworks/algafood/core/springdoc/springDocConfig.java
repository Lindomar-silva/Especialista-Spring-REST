...
import com.algaworks.algafood.api.v1.openapi.controller.model.LinksModel;
...
public class springDocConfig {
	...
	public OpenAPI openAPI() {
		...
		SpringDocUtils.getConfig().replaceWithClass(Links.class, LinksModel.class);
	...
	private Map<String, ApiResponse> gerarResponses() {
		...
		apiResponseMap.put(badRequestResponse, new ApiResponse().
				description("Requisição inválida").content(content));
		
		apiResponseMap.put(notFoundResponse, new ApiResponse()
				.description("Recurso não encontrado").content(content));
