...
public class RestauranteProdutoFotoController implements RestauranteProdutoFotoControllerOpenApi {
	...
	@Autowired
	private FotoProdutoAssembler fotoProdutoModelAssembler;
	...
	public FotoProdutoDTO atualizarFoto(@PathVariable Long restauranteId,
		...
		Produto produto = cadastroProduto.findByIdOrNotFound(restauranteId, produtoId);
	...
	public FotoProdutoDTO buscar(@PathVariable Long restauranteId, 
			@PathVariable Long produtoId) {
		FotoProduto fotoProduto = catalogoFotoProduto.findByIdOrNotFound(restauranteId, produtoId);
