...
VALUES (
	'1', 'algafood-backend', '2024-10-10 13:59:55', '$2a$10$M3t.cb5lAZRAhnzmXYRNcuEQ1bHgLQ6xEqg233OOs4iBqCE0b90Ki', NULL, 'Algafood Backend', 'client_secret_basic', 'client_credentials', '', 'READ', 
...
VALUES (
	'2', 'algafood-web', '2024-10-10 13:59:55', '$2a$10$EOY2TTr4s4HcbIrCjg9ysu5syYPL8T/QL5S3b4Bfr/SUnql073rPG', NULL, 'Algafood Web', 'client_secret_basic', 'refresh_token,authorization_code', 'http://127.0.0.1:8080/swagger-ui/oauth2-redirect.html,http://127.0.0.1:8080/authorized', 'READ,WRITE', 
...
VALUES (
	'3', 'foodanalytics', '2024-10-10 13:59:55', '$2a$10$8U/5agrMF0GSomONGmQcdu5JRfqdpILb648lMtVyvqZv8IYD/76Ha', NULL, 'Food Analytics', 'client_secret_basic', 'authorization_code', 'http://www.foodanalytics.local:8082', 'READ,WRITE', 
	'{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-proof-key":false,"settings.client.require-authorization-consent":false}', '{"@class":"java.util.Collections$UnmodifiableMap","settings.token.reuse-refresh-tokens":true,"settings.token.id-token-signature-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.token.access-token-time-to-live":["java.time.Duration",1800.000000000],"settings.token.access-token-format":{"@class":"org.springframework.security.oauth2.core.OAuth2TokenFormat","value":"self-contained"},"settings.token.refresh-token-time-to-live":["java.time.Duration",3600.000000000]}'
);
