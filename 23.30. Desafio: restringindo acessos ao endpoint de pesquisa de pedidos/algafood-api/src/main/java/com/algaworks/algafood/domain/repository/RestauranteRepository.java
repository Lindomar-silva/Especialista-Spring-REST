...
//	List<Restaurante> findByNomeContainingAndCozinhaId(String nome, Long cozinhaId);
	...
	int countById(Long restauranteId);
	
	@Modifying //https://www.baeldung.com/spring-data-jpa-modifying-annotation
	@Query("UPDATE Restaurante SET aberto = :b WHERE id = :restauranteId")
	int updateStatusAberto(Long restauranteId, boolean b);

	boolean existeResponsavelORM(Long restauranteId, Long usuarioId);
