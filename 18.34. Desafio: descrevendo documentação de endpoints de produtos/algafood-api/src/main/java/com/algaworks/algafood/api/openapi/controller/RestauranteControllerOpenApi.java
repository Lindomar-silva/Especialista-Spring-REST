...
public interface RestauranteControllerOpenApi {
	...
	List<RestauranteDTO> listarResumo();
	...
	void fechado(@ApiParam(value = "ID do restaurante", example = "1", required = true) Long restauranteId);
	...
	void aberto(@ApiParam(value = "ID do restaurante", example = "1", required = true) Long restauranteId);
}
