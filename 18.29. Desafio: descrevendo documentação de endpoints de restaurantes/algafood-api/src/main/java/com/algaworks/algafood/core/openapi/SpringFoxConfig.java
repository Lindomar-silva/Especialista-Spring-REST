...
public class SpringFoxConfig {
	...
	//                .paths(PathSelectors.ant("/restaurantes/*"))
	            ...
	            .alternateTypeRules(buildPageTypeRole(CozinhaDTO.class, typeResolver))
	            .alternateTypeRules(buildPageTypeRole(PedidoResumoDTO.class, typeResolver))
	            .apiInfo(apiInfo())
    ...
    private <T> AlternateTypeRule buildPageTypeRole(Class<T> classModel, TypeResolver typeResolver) {
