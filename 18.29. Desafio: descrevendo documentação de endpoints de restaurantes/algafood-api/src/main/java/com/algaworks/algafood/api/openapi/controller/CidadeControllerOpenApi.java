...
public interface CidadeControllerOpenApi {
	...
	public CidadeDTO buscar(@ApiParam(value = "ID da cidade", example = "1", required = true) Long cidadeId);
	...
	public CidadeDTO atualizar(@ApiParam(value = "ID da cidade", example = "1", required = true) Long cidadeId, 
	...
	public void remover(@ApiParam(value = "ID da cidade", example = "1", required = true) Long cidadeId);
}
