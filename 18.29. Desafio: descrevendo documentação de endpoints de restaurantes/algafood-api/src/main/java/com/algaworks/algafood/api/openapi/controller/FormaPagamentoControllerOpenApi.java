...
public interface FormaPagamentoControllerOpenApi {
	...
	public ResponseEntity<FormaPagamentoDTO> buscar(@ApiParam(value = "ID da forma de pagamento", 
	...
	public FormaPagamentoDTO adicionar(@ApiParam(name = "corpo", value = "Representação de uma forma de pagamento", required = true) FormaPagamentoInput formaPagamentoInput);
	...
	public FormaPagamentoDTO atualizar(@ApiParam(value = "ID da forma de paamento", example = "1", required = true) Long formaPagamentoId,
