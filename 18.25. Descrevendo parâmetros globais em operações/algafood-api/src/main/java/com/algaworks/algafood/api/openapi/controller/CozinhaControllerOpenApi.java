...
public interface CozinhaControllerOpenApi {
	...
	public CozinhaDTO adicionar(@ApiParam(name = "corpo", value = "Representação de uma cozinha") CozinhaInput cozinhaInput);
	...
	public CozinhaDTO atualizar(@ApiParam(value = "ID da cozinha", example = "1") Long cozinhaId, 
			@ApiParam(name = "corpo", value = "Representação de uma cozinha") CozinhaInput cozinhaInput);
	...
	public void remover(@ApiParam(value = "ID da cozinha") Long cozinhaId);
}
