...
public class SpringFoxConfig {
	...
	// No momento não existe uma correção definitiva, mas é possível adicionar a tela de autenticação 
	// com um campo para inserir o Token JWT (que pode ser gerado via Postman por exemplo), 
	// e assim autenticar as requisições dentro do Swagger.
    
	// https://app.algaworks.com/aulas/2296/ajustando-a-documentacao-da-api-para-suporte-a-oauth2?pagina=0
    ...
    Docket apiDocketV2() {
        ...
        return new Docket(DocumentationType.OAS_30)
	            ...
	            .apiInfo(apiInfoV2())
	            .tags(new Tag("Cidades", "Gerencia as cidades"))
	            .tags(new Tag("Cozinhas", "Gerencia as cozinhhas"));
    }
